...
- **Hosting:** Vercel
- **Auth:** Email+password (staff) + Google OAuth (للعملاء) عبر Supabase Auth. ⚠️ الخطة الأصلية «OTP عبر SMS / Unifonic» **ما تطبّقت أبداً** — راجع [`TECH-DESIGN.md §8`](./docs/architecture/TECH-DESIGN.md#8-honest-gaps--stale-doc-corrections)
- **Push:** web-push / VAPID (self-hosted). ⚠️ «OneSignal» كان قرار مبدئي **وما اتبنى**
