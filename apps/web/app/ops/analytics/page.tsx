    ...
    <div className="space-y-4">
      ...
      <p className="text-[11px] text-neutral-500 leading-relaxed">
        * <b>أجهزة/يوم</b> = عدد الأجهزة المختلفة التي فتحت القائمة يومياً (بصمة مجزّأة لـ IP+المتصفح،
        ...
        من المستخدمين، فالرقم تقديري للأسفل. يُحتسب من الفتحات المباشرة للقائمة فقط — مسح رموز QR عبر
        الروابط المختصرة لا يحمل بصمة جهاز، فلا يظهر ضمن «أجهزة/يوم» (لكنه يُحتسب ضمن «المشاهدات»). تُحذف
        بيانات الزيارات تلقائياً بعد ٩٠ يوماً. لا تُحتسب زيارات روبوتات معاينة الروابط (واتساب/تيليجرام…).
      </p>
    </div>
  );
}
